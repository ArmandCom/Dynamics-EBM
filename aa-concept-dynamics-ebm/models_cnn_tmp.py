...
class EdgeGraphEBM_OneStep(nn.Module):
    def __init__(self, args, dataset):
        ...
        self.mlp1 = MLPBlock(filter_dim * self.num_time_instances, filter_dim, filter_dim, do_prob, spectral_norm=spectral_norm)
...
class NodeID(nn.Module):
    def __init__(self, args):
        ...
        self.degister_buffer('obj_ids', obj_ids, persistent=False)
